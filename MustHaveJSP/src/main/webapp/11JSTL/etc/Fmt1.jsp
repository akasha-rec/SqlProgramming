...
<body>
	...
	콤마 O : <fmt:formatNumber value="${ number1 }" pattern="#,####"/><br /> <%-- <fmt:formatNumber>는 세자리마다 , --%>
	콤마 X : <fmt:formatNumber value="${ number1 }" groupingUsed="false"/><br /> <!-- groupingUsed="false" > , 구분X -->
